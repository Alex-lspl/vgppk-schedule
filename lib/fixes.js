...
const FIXES = {
  bg203: [
    // Английский: на сайте перепутаны дни. Яньшина Н.В. всегда ведёт в 323 кабинете
    // (1 подгруппа), Рыжкова Н.И. всегда в 355 (2 подгруппа) — преподаватель и кабинет
    // переставляются вместе, день просто определяет, у какой подгруппы когда пара.
    { day: 0, pair: 5, subject: /^Ин\. язык/i, set: { subgroup: 2, teacher: 'Рыжкова Н.И.', room: '355' } },
    { day: 1, pair: 1, subject: /^Ин\. язык/i, set: { subgroup: 1, teacher: 'Яньшина Н.В.', room: '323' } },
  ],
};
